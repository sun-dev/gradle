...
class WorkerConfigSerializerTest extends AbstractIntegrationSpec {
    ...
    def "serialized and de-serialized WorkerConfig is equivalent to original"() {
        ...
        WorkerConfig original = new WorkerConfig(
            ...
            true,
            "/path/to/user/home",
            new MultiChoiceAddress(new UUID(123, 456), 789, List.of(InetAddress.getAllByName("example.com"))),
            987,
            "name",
        ...
        processed.workerAction instanceof TaskAction
        processed.workerAction.value == original.workerAction.value
    }

    private class TestAction implements Action<WorkerProcessContext> {
